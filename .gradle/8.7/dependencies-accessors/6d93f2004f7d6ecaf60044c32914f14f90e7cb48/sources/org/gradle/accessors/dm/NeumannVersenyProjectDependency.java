...
@NonNullApi
public class NeumannVersenyProjectDependency extends DelegatingProjectDependency {

    @Inject
    public NeumannVersenyProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
